...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../Resources/plugins/css/new-article.css">
  ...
  <div class="row">
    ...
    <!-- Side-bar toggler -->
      ...
      <div class="hidden-xs pull-left" id="dash-info">
        <h4><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Dashboard <small>Staff</small></h4>
      </div>
     ...
     <div class="" id="notification">
       <ul>
        ...
        <ul class="dropdown-menu pull-left" id="profile-menu">
            ...
            <li><a href="login.jsp"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Logout </a></li>
        </ul>
        </div>
